...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    def printing(numGuesses, lettersGuessed) :
        ...
        print('-----------')
        return (numGuesses, lettersGuessed, guessed)
    
    lettersGuessed = []
    numGuesses = 8
    while numGuesses > 0 :
        (numGuesses, lettersGuessed, guessed) = printing(numGuesses, lettersGuessed)
